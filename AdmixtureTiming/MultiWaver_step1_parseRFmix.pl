...
# Step1 of formatting the RFmix local ancestry calls for Multiwaver
# 
# USAGE: perl Multiwaver_step1.pl IBS_YRI_CV.sample IBS_YRI_CV.snp_locations rfmix.Viterbi.txt 
##########################################################################
use strict;
...
foreach my $ind (keys %indivs){
	my $output = "multiwaver-parse-step1-chr$chr"."-indiv"."$ind".".txt";
